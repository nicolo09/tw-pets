                            ...
                            <div class="card result-bar"> 
                                <div class="card-body p-2">
                                    <div class="result-element"> <!-- img and label on same line to avoid empty space -->
                                        <img class="miniature" src="<?php echo IMG_DIR.$templateParams["owners"][$x]["immagine"] ?>" alt="Immagine profilo di <?php echo $templateParams["owners"][$x]["username"] ?>"/><span class="fs-4 fw-bold miniatureLabel"><?php echo $templateParams["owners"][$x]["username"] ?></span>
                                    </div>
                                </div>
                            </div>
                        </a>
