<div class="list-group-item d-flex notification" id=<?php echo "notification-" . $notification["id"] ?>>
    ...
    <button type="button" class="btn btn-danger btn-delete-notification ms-auto" id=<?php echo "btn-delete-" . $notification["id"] ?>>
        <img src=<?php echo IMG_DIR . "trash-bin.svg" ?> />
    </button>
</div>