<div class="container">
    <div class="d-grid gap-3" id="buttons-div">
        <button class="btn btn-primary" id="view-profile-button" title="Visualizza il tuo profilo"><img src="<?php echo getUserProfilePic($templateParams["user"], $dbh)?>" class="miniature"><span class="ms-1 short-text"><?php echo $templateParams["user"]; ?></span></button>
        <div class="row profile-row">
            <div class="col text-center"><button class="btn btn-secondary user-button" id="view-followed-button"><img src="img/person.svg" class="w-100">Profili che segui</button></div>
